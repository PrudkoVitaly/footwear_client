              ...
              children: [
                      ...
                      child: DropDownBtn(
                        ...
                        onChanged: (value) {
                          controller.sortByPrice(
                            ascending: value == "Rs: Low to High"
                                ? true
                                : false,
                          );
                        },
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemCount: controller.productShowInUi.length,
                    itemBuilder: (context, index) {
                      return ProductCard(
                        productImage:
                            controller.productShowInUi[index].image ?? 'Url',
                        productName:
                            controller.productShowInUi[index].name ?? 'No name',
                        productPrice:
                            controller.productShowInUi[index].price
                                ?.toString() ??
                            '0',
                        offerTag: '20% Off',
                        onTap: () {
                          Get.to(
                            ...
                            arguments: {
                              "data": controller.productShowInUi[index],
                            },
                          );
                        },
                      );
